...
For 80-bit messages, the CRC-8 algorithm appears to detected about 90% of block-insertion types of errors [ISMErrDetect](https://github.com/hdtodd/ISMErrDetect) regardless of the value of 'init', but to avoid potential pathological cases of messages with blocks of 0's or 1's, heed Williams' advice and avoid an 'init' value of 0x00.
